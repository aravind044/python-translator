...
clear_button = customtkinter.CTkButton(original_frame, text="CLEAR TEXT", font=("Helvetica", 13), 
...
translate_button = customtkinter.CTkButton(translated_frame1, text="TRANSLATE", font=("Helvetica", 13), 
                                           fg_color="#5915E4", hover_color="#4318AC", width=50, height=30, 
